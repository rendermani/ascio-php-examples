...
/**
 * Class that contains functionality for generating aws-classes from a wsdl file
 *
 * @package Wsdl2PhpGenerator
...
class Generator implements GeneratorInterface
{
    ...
    /**
     * Save all the loaded aws-classes to the configured output dir
     *
