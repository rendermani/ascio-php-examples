...
class DnsService extends SoapClient {
  ...
  public function DnsService($userName, $password, $partnerAccount = false, $actAs = false, $wsdl = "https://dnsservice.ascio.com/2010/10/30/DnsService.wsdl", $options = array()) {
